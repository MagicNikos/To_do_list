#για να τρεψει ο κώδικας πρέπει να κάνουμε τις ακόλουθες εντολές στο powershell μεσα στο folder ή στο terminal του vs code 
# virtualenv env 
...
#Σημειωματάριο με την χρήση Flask και SQlite database
#Σαλιάρης Νικόλαος 
#Ατομική εργασία για το μάθημα Εισαγωγή στην Επιστήμη του Ηλεκτρολόγου Μηχανικού 2024-2025
